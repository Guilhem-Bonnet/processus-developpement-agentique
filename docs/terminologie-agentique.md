...
| Orchestrateur de contexte avancé | Plan de contrôle qui arbitre profils, budgets, couches mémoire, sources, exclusions et persistance. |
...
| Context pack | Paquet de contexte vérifié transmis à une étape ou un subagent : sources incluses, exclusions, contraintes, scorecard et confiance. |
...
| Context constitution | Ordre d'autorité des informations : source active, preuve, décision validée, mémoire durable, handoff, hypothèse, similarité. |
